				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						<div class="row align-items-center">
							...
							<div class="col">
								<div class="small font-weight-bold text-gray-800">Guru :</div>
								<div class="small text-gray-800"><?= $t['nama_lengkap']; ?></div>
							</div>
						</div>
					</div>
					<div class="card-footer small d-flex justify-content-center">
						<a href="/aplikasi/siswa/konten-pembelajaran/<?= $t['user_id']; ?>" class="text-primary text-decoration-none">Lihat daftar konten <i class="fa fa-chevron-right fa-sm fa-fw"></i></a>
